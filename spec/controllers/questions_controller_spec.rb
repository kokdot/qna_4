...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe 'POST #create' do
    ...
    context 'with invalid attributes' do 
      ...
      before do
        patch :update, params: { id: question, question: attributes_for(:question, :invalid, user: user) } 
      end
      it 'does not change question' do
        question.reload

        expect(question.title).to eq title_old
        expect(question.body).to eq body_old
      end
